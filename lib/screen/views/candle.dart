  ...
  Widget _builBody() {
    ...
    return GetBuilder<CandleController>(builder: ((controller) {
      ...
      return Scaffold(
          appBar: AppBar(
            actions: [
              Row(children: [Text('macd: '), Checkbox(
                  checkColor: sec,
                  activeColor: wh,
                  hoverColor: sec,
                  ...
                  onChanged: (data) {
                    controller.macd.value == true ? controller.macd.value =
                    false : controller.macd.value = true;
                    controller.update();
                  })
                                ...
                                series: <
                                  ...
                                  CandleSeries<ChartSampleData,
                                    ...
                                    bearColor: Colors.red,
                                      ...
                                      opacity: 0.7,
                                      xValueMapper: (ChartSampleData sales,
                                          _) => sales.x,
                                      lowValueMapper: (ChartSampleData sales,
                                          _) => sales.low,
                                      highValueMapper: (ChartSampleData sales,
                                          _) => sales.high,
                                      openValueMapper: (ChartSampleData sales,
                                          _) => sales.open,
                                      closeValueMapper: (ChartSampleData sales,
                                          _) => sales.close,
                                      name: 'AAPL'),
...
class ChartSampleData {
  ChartSampleData(
      {required this.x, required this.open, required this.high, required this.close, required this.low, required this.volume});
